...
public class ProdutoRepositoryImpl implements ProdutoRepository {
    ...
    String userHome = System.getProperty(USER_DIR); // Recupera o diretório correto
    return MessageFormat.format("{0}{1}{2}", userHome, File.separator, BANCO_JSON); // Constrói o caminho
}
}